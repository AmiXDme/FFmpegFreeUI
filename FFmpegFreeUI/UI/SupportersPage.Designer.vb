...
Partial Class SupportersPage
    ...
    Private Sub InitializeComponent()
        ...
        Label47.Text = "Thanks to all users who provided financial and technical support for FFmpegFreeUI development."
        ' 
        ' Panel2
        ' 
        ...
        UiButton4.Font = New Font("Segoe UI", 9.75F)
        ...
        UiButton4.TipsFont = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ' 
        ' Label3
        ' 
        ...
        UiButton3.Font = New Font("Segoe UI", 9.75F)
        ...
        UiButton3.Text = "Free Gifts"
        UiButton3.TipsFont = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ' 
        ' Label2
        ' 
