...
Partial Class MediaInfoPage
    ...
    Private Sub InitializeComponent()
        ...
        Label123.Text = "Calls ffprobe.exe directly to display output info. Drag files onto the button or this top area. Not compatible with Translation Mode!"
        ...
        UiButton1.Font = New Font("Segoe UI", 10F)
